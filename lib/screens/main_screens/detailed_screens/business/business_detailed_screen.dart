...
import 'package:sekai_news/screens/main_screens/detailed_screens/business/custom_font_text_buttons.dart';

class BusinessDetailedScreen extends StatefulWidget {
  const BusinessDetailedScreen({Key? key, required this.imageUrl, required this.content, required this.title, required this.date, required this.author}) : super(key: key);
  ...
  @override
  State<BusinessDetailedScreen> createState() => _BusinessDetailedScreenState();
}

class _BusinessDetailedScreenState extends State<BusinessDetailedScreen> {
