...
import 'package:sekai_news/screens/main_screens/detailed_screens/sports/custom_font_text_buttons.dart';

class SportDetailedScreen extends StatefulWidget {
  const SportDetailedScreen({Key? key, required this.imageUrl, required this.content, required this.title, required this.date, required this.author}) : super(key: key);
